/**
 * Icônes SVG inline (style Lucide). Pas de dépendance externe — rend l'app
 * plus légère et permet de styliser via `currentColor`.
 *
 * Usage : <Icon.Search className="w-4 h-4" />
 */
